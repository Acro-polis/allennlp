...
class TestCSQADgraphLanguage(AllenNlpTestCase):
    def setUp(self):
        ...
        self.csqa_dgraph_context = CSQADgraphContext.connect_to_db(self.ip, self.entity_id2string_path,
                                                                   self.predicate_id2string_path, self.question_tokens,
                                                                   question_entities)
        self.language = CSQADgraphLanguage(self.csqa_dgraph_context)
    ...
    def _get_world_with_question_tokens_and_entities(self,
        ...
        self.csqa_dgraph_context = CSQADgraphContext.connect_to_db(self.ip, self.entity_id2string_path,
                                                                   ...
                                                                   question_entities)
        language = CSQADgraphLanguage(self.csqa_dgraph_context)
        return language
